...
args['weight_folder'] =  './checkpoint/0202113411'
...
model_cnn = timm.create_model('tf_efficientnetv2_s', pretrained=False, num_classes=1000)
...
safe_fn = str(os.path.join(args['save_folder'], 'model_001')) + '.csv'
